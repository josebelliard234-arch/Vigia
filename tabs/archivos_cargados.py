...
def render_archivos_cargados():
    ...
    for semana_m, nombre_m, fecha_m, registros_m in monitoreos:
        ...
        with col_info:
            st.markdown(
                f"<div style='padding:.6rem .8rem;border:1px solid var(--bdm);"
                f"border-radius:12px;background:var(--bg-subtle);'>"
                ...
                f"<div style='font-size:.72rem;color:var(--t2);margin-top:.08rem;'>"
